...
namespace HelloWorld
{
    ...
    // Camel casing - Capitalize on word boundaries except first word (e.g firstName, payRate)
    class Program
    {
        // function declaration - declaration to compiler that a function exist with a given signature
        // Function signature - fuction name and the parameter types (sometimes it will include return type)
